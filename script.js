...
analyzeBtn.onclick = async () => {
  ...
  try {
    ...
    // 4. รับผลลัพธ์จาก Webhook Response (ในรูปแบบ JSON)
    ...
    // เปลี่ยนสีตัวเลขความเครียดตามเกณฑ์
