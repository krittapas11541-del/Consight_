...
// ==========================================
// 3. KNOWLEDGE BASE & SCENARIOS (สำรองไว้ใช้)
// ==========================================
const scenarios = [
  {
    id: 'academic',
...
// ==========================================
// 4. ANALYZE ACTION (ส่งข้อมูลไปที่ Google Apps Script)
// ==========================================
analyzeBtn.onclick = async () => {
  ...
  const webhookUrl = 'https://script.google.com/macros/s/AKfycbwHiK0gqF2l7Kgb5LIP1ZgZU2Thao4AOcq_Nd1sGJeclMykHcwUslQg29JrgbTz-56ZBQ/exec';

  try {
    const response = await fetch(webhookUrl, {
      method: 'POST',
      // ใช้ text/plain เพื่อกันเบราว์เซอร์บล็อก (CORS)
      headers: {
    ...
    // นำข้อมูลที่ Google ส่งกลับมา แสดงบนหน้าเว็บ
