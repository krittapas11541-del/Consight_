...
analyzeBtn.onclick = async () => {}
 ...
 // นำ URL ของเว็บแอปจาก Google มาวางในช่องนี้
  const webhookUrl = 'https://script.google.com/macros/s/AKfycbwa5ns1zCcyecx3oOUqQ2j4xW4JE1wuD8SteCM_wYPIZidkHsO4pJDZJppyqNeQgzhpxw/exec';

  try {
    const response = await fetch(webhookUrl, {
      method: 'POST',
      // ใช้ text/plain เพื่อหลีกเลี่ยงระบบความปลอดภัย (CORS) ของเบราว์เซอร์
      headers: {
